    ...
    <section class="w-full px-4">
        <header :id="`header-${id}`" class="w-full">
            <figure class="book.thumb">
                <img v-on:click="() => {showOverlay()}" :id="`thumb-${id}`" class="mx-auto" src="@/assets/images/books/book2/Tex_01.jpg" alt="">
            </figure>
        ...
        <section :id="`book-${id}`" class="fixed w-full full-height left-0 top-0 bg-transparent hidden overflow-hidden">
            <section class="w-full screen relative mx-auto full-height flex items-center">
                ...
                <section :id="id" class="book.canvas m-auto opacity-0">
                    <!-- Capa -->
                    <section class="book2.bg hard bg-gray-100">
                    </section>
                    <section :key="'pag-'+n" v-for="n in 49" :class="`book2.pag-${n+1}`" >
                    </section>
                </section>
...
.book2\\.bg
    background-image url('../../assets/images/books/book2/Tex_01.jpg')
    ...
    //     background-size cover
    //     background-image url('../../assets/images/books/book2/images.jpg')
for $num in (2..50)
    .book2\\.pag-{$num}
        background-image url('../../assets/images/books/book2/Tex_'+ $num +'.jpg')
        background-position center center
        background-size cover
